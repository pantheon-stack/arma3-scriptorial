...
_item146 = createGroup resistance;
_this = _item146;
_groups pushback _this;
_groupIDs pushback 146;

_item151 = createGroup resistance;
_this = _item151;
_groups pushback _this;
_groupIDs pushback 151;

_item156 = createGroup resistance;
_this = _item156;
_groups pushback _this;
_groupIDs pushback 156;

_item161 = createGroup resistance;
_this = _item161;
_groups pushback _this;
...
_item67 = _item65 createUnit ["UK3CB_TKM_I_RIF_1",[1259,3881,0.630798],[],0,"CAN_COLLIDE"];
_this = _item67;
_objects pushback _this;
_objectIDs pushback 67;
_this setPosWorld [1259,3881.05,211.732];
_this setVectorDirAndUp [[0.0310484,-0.999517,0.00116286],[-0.00804547,0.000913461,0.999967]];
F1_veh_2_2 = _this;
...
_item68 = _item65 createUnit ["UK3CB_TKM_I_RIF_1",[1258,3883,0.692612],[],0,"CAN_COLLIDE"];
_item65 selectLeader _item68;
_this = _item68;
_objects pushback _this;
_objectIDs pushback 68;
_this setPosWorld [1258,3883.05,211.787];
_this setVectorDirAndUp [[-0.766205,0.642579,0.00456934],[0.0139392,0.00951106,0.999858]];
F1_veh_2_1 = _this;
...
_item134 = createVehicle ["UK3CB_TKA_I_Mi_24V",[118.138,7889.06,-0.0039978],[],0,"CAN_COLLIDE"];
_this = _item134;
_objects pushback _this;
...
_item142 = _item141 createUnit ["UK3CB_TKM_I_TL",[2035,5083,0],[],0,"CAN_COLLIDE"];
_item141 selectLeader _item142;
_this = _item142;
_objects pushback _this;
_objectIDs pushback 142;
_this setPosWorld [2035,5083.05,198.721];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setRank "SERGEANT";
_this setname "Mufid Tanwir";;
_this setface "asczHead_boomlakhaoo_A3";;
_this setspeaker "Male02PER";;
_this setpitch 1.02;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
...
_item143 = _item141 createUnit ["UK3CB_TKM_I_MG",[2038,5080,0],[],0,"CAN_COLLIDE"];
_this = _item143;
_objects pushback _this;
_objectIDs pushback 143;
_this setPosWorld [2038,5080.05,198.671];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.45;
_this setRank "CORPORAL";
_this setname "Sadat Takhtar";;
_this setface "PersianHead_A3_03";;
_this setspeaker "male01per";;
_this setpitch 0.97205;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item144 = _item141 createUnit ["UK3CB_TKM_I_MG_ASST",[2040,5080,0],[],0,"CAN_COLLIDE"];
_this = _item144;
_objects pushback _this;
_objectIDs pushback 144;
_this setPosWorld [2040,5080.05,198.567];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.4;
_this setname "Sibhatullah Fahim";;
_this setface "PersianHead_A3_01";;
_this setspeaker "male02per";;
_this setpitch 0.981043;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item145 = _item141 createUnit ["UK3CB_TKM_I_RIF_1",[2042,5080,0],[],0,"CAN_COLLIDE"];
_this = _item145;
_objects pushback _this;
_objectIDs pushback 145;
_this setPosWorld [2042,5080.05,198.484];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.4;
_this setname "Ismail Muhtaram";;
_this setface "PersianHead_A3_03";;
_this setspeaker "male01per";;
_this setpitch 0.956742;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item147 = _item146 createUnit ["UK3CB_TKM_I_TL",[2066,5122,0],[],0,"CAN_COLLIDE"];
_item146 selectLeader _item147;
_this = _item147;
_objects pushback _this;
_objectIDs pushback 147;
_this setPosWorld [2066,5122.05,196.325];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setRank "SERGEANT";
_this setname "Azim Siddiqi";;
_this setface "PersianHead_A3_01";;
_this setspeaker "male01per";;
_this setpitch 0.998448;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item148 = _item146 createUnit ["UK3CB_TKM_I_RIF_2",[2069,5119,0],[],0,"CAN_COLLIDE"];
_this = _item148;
_objects pushback _this;
_objectIDs pushback 148;
_this setPosWorld [2069,5119.05,196.349];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.45;
_this setRank "CORPORAL";
_this setname "Idris Shah";;
_this setface "PersianHead_A3_01";;
_this setspeaker "male01per";;
_this setpitch 1.00309;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item149 = _item146 createUnit ["UK3CB_TKM_I_LAT",[2071,5119,0],[],0,"CAN_COLLIDE"];
_this = _item149;
_objects pushback _this;
_objectIDs pushback 149;
_this setPosWorld [2071,5119.05,196.345];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.4;
_this setname "Abdullah Aybak";;
_this setface "PersianHead_A3_01";;
_this setspeaker "male02per";;
_this setpitch 0.979246;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item150 = _item146 createUnit ["UK3CB_TKM_I_RIF_1",[2073,5119,0],[],0,"CAN_COLLIDE"];
_this = _item150;
_objects pushback _this;
_objectIDs pushback 150;
_this setPosWorld [2073,5119.05,196.342];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.4;
_this setname "Qadeer Anwari";;
_this setface "asczHead_boomlakhaoo_A3";;
_this setspeaker "male01per";;
_this setpitch 0.992497;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item152 = _item151 createUnit ["UK3CB_TKM_I_TL",[1660.33,4994.2,0],[],0,"CAN_COLLIDE"];
_item151 selectLeader _item152;
_this = _item152;
_objects pushback _this;
_objectIDs pushback 152;
_this setPosWorld [1660.33,4994.25,312.065];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setRank "SERGEANT";
_this setname "Haikal Ahmed-Jan";;
_this setface "asczHead_boomlakhaoo_A3";;
_this setspeaker "male01per";;
_this setpitch 0.959647;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item153 = _item151 createUnit ["UK3CB_TKM_I_RIF_2",[1663.33,4991.2,0],[],0,"CAN_COLLIDE"];
_this = _item153;
_objects pushback _this;
_objectIDs pushback 153;
_this setPosWorld [1663.33,4991.25,311.779];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.45;
_this setRank "CORPORAL";
_this setname "Mahmood Kakar";;
_this setface "PersianHead_A3_01";;
_this setspeaker "male02per";;
_this setpitch 0.971476;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item154 = _item151 createUnit ["UK3CB_TKM_I_LAT",[1665.33,4991.2,-3.05176e-005],[],0,"CAN_COLLIDE"];
_this = _item154;
_objects pushback _this;
_objectIDs pushback 154;
_this setPosWorld [1665.33,4991.25,311.139];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.4;
_this setname "Faisal Mohammadi";;
_this setface "PersianHead_A3_02";;
_this setspeaker "male02per";;
_this setpitch 1.02874;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item155 = _item151 createUnit ["UK3CB_TKM_I_RIF_1",[1667.33,4991.2,-3.05176e-005],[],0,"CAN_COLLIDE"];
_this = _item155;
_objects pushback _this;
_objectIDs pushback 155;
_this setPosWorld [1667.33,4991.25,310.598];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.4;
_this setname "Aslan Shah";;
_this setface "PersianHead_A3_01";;
_this setspeaker "male02per";;
_this setpitch 0.98708;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item157 = _item156 createUnit ["UK3CB_TKM_I_TL",[2211.69,4822.56,0],[],0,"CAN_COLLIDE"];
_item156 selectLeader _item157;
_this = _item157;
_objects pushback _this;
_objectIDs pushback 157;
_this setPosWorld [2211.69,4822.61,292.152];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setRank "SERGEANT";
_this setname "Latif Nazari";;
_this setface "PersianHead_A3_02";;
_this setspeaker "male01per";;
_this setpitch 1.01511;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item158 = _item156 createUnit ["UK3CB_TKM_I_RIF_2",[2214.69,4819.56,0],[],0,"CAN_COLLIDE"];
_this = _item158;
_objects pushback _this;
_objectIDs pushback 158;
_this setPosWorld [2214.69,4819.61,292.931];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.45;
_this setRank "CORPORAL";
_this setname "Akbar Takhtar";;
_this setface "PersianHead_A3_01";;
_this setspeaker "male02per";;
_this setpitch 1.02183;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item159 = _item156 createUnit ["UK3CB_TKM_I_LAT",[2216.69,4819.56,0],[],0,"CAN_COLLIDE"];
_this = _item159;
_objects pushback _this;
_objectIDs pushback 159;
_this setPosWorld [2216.69,4819.61,292.49];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.4;
_this setname "Abdullah Wardak";;
_this setface "PersianHead_A3_01";;
_this setspeaker "male02per";;
_this setpitch 0.973173;;
if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
_this setVariable ['ACE_isEOD', false, true];
if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
_item160 = _item156 createUnit ["UK3CB_TKM_I_RIF_1",[2218.69,4819.56,0],[],0,"CAN_COLLIDE"];
_this = _item160;
_objects pushback _this;
_objectIDs pushback 160;
_this setPosWorld [2218.69,4819.61,292.034];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.4;
_this setname "Mahmood Ahmed-Jan";;
_this setface "PersianHead_A3_01";;
_this setspeaker "male02per";;
...
_item162 = _item161 createUnit ["UK3CB_TKM_I_TL",[1829.44,4760.47,-1.52588e-005],[],0,"CAN_COLLIDE"];
_item161 selectLeader _item162;
_this = _item162;
_objects pushback _this;
_objectIDs pushback 162;
_this setPosWorld [1829.44,4760.52,199.583];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setRank "SERGEANT";
_this setname "Idris Jawadi";;
_this setface "asczHead_obacki_A3";;
_this setspeaker "male03per";;
...
_item163 = _item161 createUnit ["UK3CB_TKM_I_RIF_2",[1832.44,4757.47,0],[],0,"CAN_COLLIDE"];
_this = _item163;
_objects pushback _this;
_objectIDs pushback 163;
_this setPosWorld [1832.44,4757.52,200.45];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.45;
_this setRank "CORPORAL";
_this setname "Mufid Bakhtari";;
_this setface "asczHead_boomlakhaoo_A3";;
_this setspeaker "male02per";;
...
_item164 = _item161 createUnit ["UK3CB_TKM_I_LAT",[1834.44,4757.47,0],[],0,"CAN_COLLIDE"];
_this = _item164;
_objects pushback _this;
_objectIDs pushback 164;
_this setPosWorld [1834.44,4757.52,200.923];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.4;
...
_item165 = _item161 createUnit ["UK3CB_TKM_I_RIF_1",[1836.44,4757.47,0],[],0,"CAN_COLLIDE"];
_this = _item165;
_objects pushback _this;
_objectIDs pushback 165;
_this setPosWorld [1836.44,4757.52,201.391];
_this setVectorDirAndUp [[0,1,0],[0,0,1]];
_this setSkill 0.4;
_this setname "Jabr Ghafurzai";;
_this setface "PersianHead_A3_02";;
_this setspeaker "male02per";;
...
if !(units _this isEqualTo []) then {
	[_this,0] setWaypointPosition [position leader _this,0];
	                            if (isNil 'CBA_fnc_setCallsign') then {                                _this setGroupID ["F1 Alpha 3-7"];                            } else {                                [_this, "F1 Alpha 3-7"] call CBA_fnc_setCallsign;                            };                        ;
	_this setBehaviour "SAFE";
};
_this = _item146;
if !(units _this isEqualTo []) then {
	[_this,0] setWaypointPosition [position leader _this,0];
	                            if (isNil 'CBA_fnc_setCallsign') then {                                _this setGroupID ["F1 Alpha 3-3"];                            } else {                                [_this, "F1 Alpha 3-3"] call CBA_fnc_setCallsign;                            };                        ;
	_this setBehaviour "SAFE";
};
_this = _item151;
if !(units _this isEqualTo []) then {
	[_this,0] setWaypointPosition [position leader _this,0];
	                            if (isNil 'CBA_fnc_setCallsign') then {                                _this setGroupID ["F1 Alpha 3-4"];                            } else {                                [_this, "F1 Alpha 3-4"] call CBA_fnc_setCallsign;                            };                        ;
	_this setBehaviour "SAFE";
};
_this = _item156;
if !(units _this isEqualTo []) then {
	[_this,0] setWaypointPosition [position leader _this,0];
	                            if (isNil 'CBA_fnc_setCallsign') then {                                _this setGroupID ["F1 Alpha 3-5"];                            } else {                                [_this, "F1 Alpha 3-5"] call CBA_fnc_setCallsign;                            };                        ;
	_this setBehaviour "SAFE";
};
_this = _item161;
if !(units _this isEqualTo []) then {
	[_this,0] setWaypointPosition [position leader _this,0];
	                            if (isNil 'CBA_fnc_setCallsign') then {                                _this setGroupID ["F1 Alpha 3-6"];                            } else {                                [_this, "F1 Alpha 3-6"] call CBA_fnc_setCallsign;                            };                        ;
	_this setBehaviour "SAFE";
};
...
_item98 = _item65 addWaypoint [[1260,3883,0.763931],0];
_this = _item98;
_waypoints pushback _this;
...
_this setWaypointStatements ["true","[this, this, 1000] call CBA_fnc_taskPatrol"];
_this setWaypointType "MOVE";
